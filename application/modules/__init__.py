...
global_role = [
    ...
    {'module': 'Gestion des demandes', 'valeur': 'module_demande',
     'role': [
         {'titre': 'Traitement des reclamations ', 'valeur': 'claim', 'action': 1},
...
global_contact_tags = [
    {'name': 'Afficher le nom', 'parent': ''},
    {'name': 'Contact de Societe', 'parent': ''},
    {'name': 'Acheteur de composants', 'parent': ''},
    {'name': 'Services de consultation', 'parent': ''},
    {'name': 'Distributeur', 'parent': ''},
    {'name': 'Employe', 'parent': ''},
    {'name': 'Fabricant', 'parent': ''},
    {'name': 'Fournitures de bureau', 'parent': ''},
    {'name': 'Partenaire', 'parent': ''},
    {'name': 'Bronze', 'parent': 'Partenaire'},
    {'name': 'Or', 'parent': 'Partenaire'},
    {'name': 'Services Informatiques', 'parent': 'Partenaire'},
    {'name': 'Argent', 'parent': 'Partenaire'},
    {'name': 'Prospect', 'parent': ''},
    {'name': 'Detaillant', 'parent': ''},
    {'name': 'Services', 'parent': ''},
    {'name': 'Fournisseur', 'parent': ''},
    {'name': 'Grossiste', 'parent': ''}
]
