...
PREV_DISABLED_PAGES = dict(bootstrap=_bs_prev_disabled_page,
                           ...
                           uikit=_bs_prev_disabled_page_ui,
                           foundation=FA_LINK,
                           )

_bs_next_disabled_page = '<li class="next disabled">\
<a> {0} </a></li>'
_bs_next_disabled_page_ui = '<li class="uk-disabled">\
<span uk-pagination-next>{0}</span></li>'
NEXT_DISABLED_PAGES = dict(bootstrap=_bs_next_disabled_page,
                           ...
                           uikit=_bs_next_disabled_page_ui,
                           foundation=FA_LINK,
                           )
...
CSS_LINKS = dict(bootstrap='<div class="pagination{0}{1}"><ul>',
                 ...
                 uikit='<ul class="uk-pagination{0}{1}" uk-margin>',
